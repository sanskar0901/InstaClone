        ...
        <div>
            <div className={Styles.card}>
                <div className={Styles.head}>
                    <div className={Styles.imageholder}><img className={Styles.profileimg} src={post.profilepic} alt="" />
                    </div>
                    <div className={Styles.headcont}>
                        <div className={Styles.Profiledetails}>
                            <h6 className={Styles.username}>{post.username}</h6>
                            <h6 className={Styles.postloc}>{post.location}</h6>
                        </div>
                        <div className={Styles.menu}>
                            <FontAwesomeIcon className={Styles.dots} icon={faEllipsisH} />
                        </div>
                    </div>
                </div>
                <img className={Styles.Postimg} src={post.postimg} alt=""></img>
                <div className={Styles.down}>
                    <div className={Styles.cont}>
                        <div className={Styles.likshr}>
